          ...
          <div className="bg-white border border-slate-300 shadow-xs p-4 sm:p-6 lg:p-8 space-y-6">
            ...
            {currentStep === 6 && (
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div><label className={labelStyle}>Pathologist Name <span className="text-red-600">*</span></label><input type="text" required placeholder="e.g. Dr. John Doe" value={formData.pathologist} onChange={(e) => handleInputChange("pathologist", e.target.value)} className={inputStyle} /></div>
