...
}, { timestamps: true, collection: 'pathology_reports' });

PathologySchema.index({ caseId: 1 });

const Pathology = mongoose.models.Pathology || mongoose.model('Pathology', PathologySchema);
